            ...
            <div class="col-md-8">
                ...
                <div class="post-container container">
                  ...
                  <?php
                    ...
                    post.author= user.user_id WHERE post.category= $cat_id ORDER BY post.post_id DESC LIMIT $offset,$limit";
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="inner-content clearfix">
                                        ...
                                        <p class="description"><?php echo substr($row['description'],0,150);   ?>
                                        </p>
